  ...
  <div class="sec-cont">
    ...
    <div class="bg-white rounded-md shadow overflow-hidden w-full">
      <form @submit.prevent="store">
        ...
        <div class="px-8 py-4 bg-gray-50 border-t border-gray-100 flex justify-start items-center">
          <loading-button :loading="form.processing" class="btn-indigo" type="submit">{{ $t('Create Workspace Type') }}</loading-button>
        </div>
      </form>
    </div>
  </div>
