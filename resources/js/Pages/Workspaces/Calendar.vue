<template>
    <div class="h-full">
        ...
        <div class="flex flex-col flex-grow-1 flex-shrink-1 h-full">
            <workspace-view-menu :workspace="workspace" @filter-toggle="open_filter = !open_filter" :filters="filters" view="calendar" />
                                ...
                                >
                                    ...
                                    <div class="space-y-1.5 flex-1">
                                        ...
                                        <div
                                            ...
                                            :key="'g-' + gEvent.id"
                                            class="text-xs p-2 rounded-xl bg-green-50 border border-green-200 hover:bg-green-100 transition-all duration-200"
                                            :title="gEvent.title"
                                        >
                                            <div class="flex items-center space-x-1.5">
