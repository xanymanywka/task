            ...
            <div class="flex-1 flex flex-col bg-gradient-to-br from-gray-50 to-white">
                <div v-if="timelineReady" class="flex-1 flex flex-col m-4 bg-white rounded-2xl shadow-xl border border-gray-200/60 overflow-hidden">
                    ...
                    <div class="timeline-content flex-1 overflow-hidden">
                        <!-- Month View -->
                        <div v-if="timelineView === 'month'" class="month-view h-full flex flex-col">
                        ...
                        <!-- Week View -->
                        <div v-else-if="timelineView === 'week'" class="week-view h-full flex flex-col">
                            <div class="flex-1 overflow-y-auto p-6">
                                <div class="timeline-container">
                        ...
                        <!-- Day View -->
                        <div v-else-if="timelineView === 'day'" class="day-view h-full flex flex-col">
                            <div class="flex-1 overflow-y-auto p-6">
                                <div class="timeline-container">
...
export default {
    ...
    data() {
        return {
            timelineReady: false,
            open_filter: false,
            timelineView: 'month', // Timeline view mode (month/week/day)
            pageView: 'timeline', // Page view (board/calendar/timeline/table)
            viewOptions: [
