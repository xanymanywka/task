...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full" }, _attrs))} data-v-fb4fd2f3>`);
  _push(ssrRenderComponent(_component_Head, {
    title: _ctx.$t($props.title)
  }, null, _parent));
  _push(`<div class="flex flex-col flex-grow-1 flex-shrink-1 h-full" data-v-fb4fd2f3>`);
  ...
  _push(`<div class="flex-1 flex flex-col bg-gradient-to-br from-gray-50 to-white" data-v-fb4fd2f3>`);
  if ($data.timelineReady) {
    _push(`<div class="flex-1 flex flex-col m-4 bg-white rounded-2xl shadow-xl border border-gray-200/60 overflow-hidden" data-v-fb4fd2f3><div class="timeline-header border-b border-gray-200/60 bg-gradient-to-r from-white via-gray-50/30 to-white" data-v-fb4fd2f3><div class="px-6 py-5" data-v-fb4fd2f3><div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6" data-v-fb4fd2f3><div class="flex items-center justify-center lg:justify-start" data-v-fb4fd2f3><div class="flex items-center bg-white rounded-2xl shadow-sm border border-gray-200/60 p-1" data-v-fb4fd2f3><button class="p-3 hover:bg-gray-50 rounded-xl transition-all duration-200 group" data-v-fb4fd2f3>`);
    _push(ssrRenderComponent(_component_icon, {
      name: "arrow-left",
      class: "w-5 h-5 text-gray-600 group-hover:text-indigo-600 transition-colors"
    }, null, _parent));
    _push(`</button><div class="px-6 text-center min-w-[200px]" data-v-fb4fd2f3><h2 class="text-2xl font-bold text-gray-900 tracking-tight" data-v-fb4fd2f3>${ssrInterpolate($options.currentPeriodTitle)}</h2><p class="text-sm text-gray-500 mt-0.5 font-medium" data-v-fb4fd2f3>${ssrInterpolate($options.currentPeriodSubtitle)}</p></div><button class="p-3 hover:bg-gray-50 rounded-xl transition-all duration-200 group" data-v-fb4fd2f3>`);
    _push(ssrRenderComponent(_component_icon, {
      name: "arrow-right",
      class: "w-5 h-5 text-gray-600 group-hover:text-indigo-600 transition-colors"
    }, null, _parent));
    _push(`</button></div></div><div class="flex flex-col sm:flex-row items-center gap-4" data-v-fb4fd2f3><div class="flex bg-gray-100/80 rounded-2xl p-1.5 shadow-sm border border-gray-200/40" data-v-fb4fd2f3><!--[-->`);
    ssrRenderList($data.availableViews, (view) => {
      ...
      ])}"${ssrRenderAttr("title", view.description)} data-v-fb4fd2f3>`);
      _push(ssrRenderComponent(_component_icon, {
        name: view.icon,
        class: "w-4 h-4 mr-2"
      }, null, _parent));
    ...
    _push(`<!--]--></div><button class="flex items-center px-4 py-2.5 text-sm font-medium text-gray-600 hover:text-gray-900 bg-white hover:bg-gray-50 rounded-xl border border-gray-200/60 transition-all duration-200" data-v-fb4fd2f3>`);
    _push(ssrRenderComponent(_component_icon, {
      name: "calendar-today",
      class: "w-4 h-4 mr-2"
    }, null, _parent));
    _push(` Today </button></div></div></div></div><div class="timeline-content flex-1 overflow-hidden" data-v-fb4fd2f3>`);
    if ($data.currentView === "month") {
      _push(`<div class="month-view h-full flex flex-col" data-v-fb4fd2f3><div class="flex-1 overflow-y-auto p-6" data-v-fb4fd2f3><div class="timeline-container" data-v-fb4fd2f3><!--[-->`);
      ssrRenderList($options.monthsInView, (month) => {
        _push(`<div class="mb-8" data-v-fb4fd2f3><div class="month-header mb-6" data-v-fb4fd2f3><h3 class="text-xl font-bold text-gray-900" data-v-fb4fd2f3>${ssrInterpolate(month.name)} ${ssrInterpolate(month.year)}</h3><div class="w-full h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent mt-2" data-v-fb4fd2f3></div></div><div class="timeline-events space-y-4" data-v-fb4fd2f3><!--[-->`);
        ssrRenderList($options.getTasksForMonth(month.month, month.year), (task) => {
          ...
          ])}" data-v-fb4fd2f3><div class="flex items-start justify-between" data-v-fb4fd2f3><div class="flex-1" data-v-fb4fd2f3><h4 class="font-semibold text-gray-900 mb-1" data-v-fb4fd2f3>${ssrInterpolate(task.title)}</h4>`);
          if (task.description) {
            _push(`<p class="text-sm text-gray-600 mb-2 line-clamp-2" data-v-fb4fd2f3>${ssrInterpolate(task.description)}</p>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="flex items-center space-x-4 text-xs text-gray-500" data-v-fb4fd2f3>`);
          if (task.list) {
            _push(`<span class="flex items-center" data-v-fb4fd2f3>`);
            _push(ssrRenderComponent(_component_icon, {
              name: "list",
              class: "w-3 h-3 mr-1"
            }, null, _parent));
          ...
          _push(`</div></div><div class="flex items-center space-x-2 ml-4" data-v-fb4fd2f3>`);
          if (task.taskLabels && task.taskLabels.length) {
            _push(`<div class="flex space-x-1" data-v-fb4fd2f3><!--[-->`);
            ssrRenderList(task.taskLabels.slice(0, 3), (label) => {
              _push(`<span style="${ssrRenderStyle({ backgroundColor: label.label.color + "20", color: label.label.color })}" class="px-2 py-1 rounded-full text-xs font-medium" data-v-fb4fd2f3>${ssrInterpolate(label.label.name)}</span>`);
            });
            _push(`<!--]--></div>`);
          } else {
            _push(`<!---->`);
          ...
          if ($options.isOverdue(task)) {
            _push(`<div class="text-red-500" data-v-fb4fd2f3>`);
            _push(ssrRenderComponent(_component_icon, {
      ...
      _push(`<div class="week-view h-full flex flex-col" data-v-fb4fd2f3><div class="flex-1 overflow-y-auto p-6" data-v-fb4fd2f3><div class="timeline-container" data-v-fb4fd2f3><!--[-->`);
      ssrRenderList($options.weeksInView, (week) => {
        _push(`<div class="mb-8" data-v-fb4fd2f3><div class="week-header mb-6" data-v-fb4fd2f3><h3 class="text-lg font-bold text-gray-900" data-v-fb4fd2f3>${ssrInterpolate($options.formatWeekRange(week.start, week.end))}</h3><div class="w-full h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent mt-2" data-v-fb4fd2f3></div></div><div class="timeline-events space-y-3" data-v-fb4fd2f3><!--[-->`);
      ...
      _push(`<div class="day-view h-full flex flex-col" data-v-fb4fd2f3><div class="flex-1 overflow-y-auto p-6" data-v-fb4fd2f3><div class="timeline-container" data-v-fb4fd2f3><div class="day-header mb-6" data-v-fb4fd2f3><h3 class="text-xl font-bold text-gray-900" data-v-fb4fd2f3>${ssrInterpolate($options.formatFullDate($data.selectedDate))}</h3><div class="w-full h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent mt-2" data-v-fb4fd2f3></div></div><div class="timeline-events space-y-3" data-v-fb4fd2f3><!--[-->`);
    ...
    _push(`<div class="flex-1 flex items-center justify-center" data-v-fb4fd2f3><div class="text-center" data-v-fb4fd2f3><div class="animate-spin rounded-full h-12 w-12 border-b-2 border-indigo-600 mx-auto mb-4" data-v-fb4fd2f3></div><p class="text-gray-600" data-v-fb4fd2f3>Loading timeline...</p></div></div>`);
  }
  _push(`</div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Projects/Timeline.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Timeline = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-fb4fd2f3"]]);
export {
  Timeline as default
};
