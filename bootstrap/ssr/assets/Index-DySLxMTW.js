...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><div class="bg-white rounded-md shadow overflow-x-auto"><table class="w-full whitespace-nowrap"><tbody><tr class="text-left font-bold"><th class="px-6 pt-6 pb-4">#${ssrInterpolate(_ctx.$t("ID"))}</th><th class="px-6 pt-6 pb-4">${ssrInterpolate(_ctx.$t("Name"))}</th><th class="px-6 pt-6 pb-4">${ssrInterpolate(_ctx.$t("Slug"))}</th><th class="px-6 pt-6 pb-4">${ssrInterpolate(_ctx.$t("Create Workspace"))}</th><th class="px-6 pt-6 pb-4">${ssrInterpolate(_ctx.$t("Create Project"))}</th></tr><!--[-->`);
  ssrRenderList($props.roles.data, (role) => {
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(!!role.create_workspace)}`);
        } else {
          return [
            createTextVNode(toDisplayString(!!role.create_workspace), 1)
          ];
        }
      }),
      _: 2
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(!!role.create_project)}`);
        } else {
          return [
            createTextVNode(toDisplayString(!!role.create_project), 1)
          ];
        }
      }),
      _: 2
