import { mergeProps, useSSRContext, resolveComponent, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, ref, computed, onMounted, onUnmounted, unref, createTextVNode, resolveDirective } from "vue";
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderSlot, ssrRenderTeleport, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseEqual, ssrGetDirectiveProps } from "vue/server-renderer";
...
function _sfc_ssrRender$a(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  if ($props.name === "apple") {
    ...
    }, _attrs))}><path d="M10.268 21a2 2 0 0 0 3.464 0"></path><path d="M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326"></path></svg>`);
  ...
  } else if ($props.name === "incomplete") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 512 512",
      fill: "currentColor"
    }, _attrs))}><path d="M512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 32C132.3 32 32 132.3 32 256C32 379.7 132.3 480 256 480C379.7 480 480 379.7 480 256C480 132.3 379.7 32 256 32z"></path></svg>`);
  } else if ($props.name === "complete") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 512 512",
      fill: "currentColor"
    }, _attrs))}><path d="M235.3 331.3C229.1 337.6 218.9 337.6 212.7 331.3L148.7 267.3C142.4 261.1 142.4 250.9 148.7 244.7C154.9 238.4 165.1 238.4 171.3 244.7L224 297.4L340.7 180.7C346.9 174.4 357.1 174.4 363.3 180.7C369.6 186.9 369.6 197.1 363.3 203.3L235.3 331.3zM512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM256 32C132.3 32 32 132.3 32 256C32 379.7 132.3 480 256 480C379.7 480 480 379.7 480 256C480 132.3 379.7 32 256 32z"></path></svg>`);
    ...
    _push(`<svg${ssrRenderAttrs(mergeProps({ viewBox: "0 0 512 512" }, _attrs))}><path d="M0 80C0 71.16 7.164 64 16 64H432C440.8 64 448 71.16 448 80C448 88.84 440.8 96 432 96H16C7.164 96 0 88.84 0 80zM64 240C64 231.2 71.16 224 80 224H496C504.8 224 512 231.2 512 240C512 248.8 504.8 256 496 256H80C71.16 256 64 248.8 64 240zM432 416H16C7.164 416 0 408.8 0 400C0 391.2 7.164 384 16 384H432C440.8 384 448 391.2 448 400C448 408.8 440.8 416 432 416z"></path></svg>`);
    ...
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 448 512",
      fill: "currentColor"
    }, _attrs))}><path d="M136 32h-112C10.75 32 0 42.75 0 56v112C0 181.3 10.75 192 24 192C37.26 192 48 181.3 48 168V80h88C149.3 80 160 69.25 160 56S149.3 32 136 32zM424 32h-112C298.7 32 288 42.75 288 56c0 13.26 10.75 24 24 24h88v88C400 181.3 410.7 192 424 192S448 181.3 448 168v-112C448 42.75 437.3 32 424 32zM136 432H48v-88C48 330.7 37.25 320 24 320S0 330.7 0 344v112C0 469.3 10.75 480 24 480h112C149.3 480 160 469.3 160 456C160 442.7 149.3 432 136 432zM424 320c-13.26 0-24 10.75-24 24v88h-88c-13.26 0-24 10.75-24 24S298.7 480 312 480h112c13.25 0 24-10.75 24-24v-112C448 330.7 437.3 320 424 320z"></path></svg>`);
  } else if ($props.name === "download") {
    _push(`<svg${ssrRenderAttrs(mergeProps({ viewBox: "0 0 512 512" }, _attrs))}><path d="M448 304h-53.5l-48 48H448c8.822 0 16 7.178 16 16V448c0 8.822-7.178 16-16 16H64c-8.822 0-16-7.178-16-16v-80C48 359.2 55.18 352 64 352h101.5l-48-48H64c-35.35 0-64 28.65-64 64V448c0 35.35 28.65 64 64 64h384c35.35 0 64-28.65 64-64v-80C512 332.7 483.3 304 448 304zM432 408c0-13.26-10.75-24-24-24S384 394.7 384 408c0 13.25 10.75 24 24 24S432 421.3 432 408zM239 368.1C243.7 373.7 249.8 376 256 376s12.28-2.344 16.97-7.031l136-136c9.375-9.375 9.375-24.56 0-33.94s-24.56-9.375-33.94 0L280 294.1V24C280 10.75 269.3 0 256 0S232 10.75 232 24v270.1L136.1 199c-9.375-9.375-24.56-9.375-33.94 0s-9.375 24.56 0 33.94L239 368.1z"></path></svg>`);
  } else if ($props.name === "keyboard") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 576 512",
      fill: "currentColor"
    }, _attrs))}><path d="M512 64H64C28.65 64 0 92.65 0 128v256c0 35.35 28.65 64 64 64h448c35.35 0 64-28.65 64-64V128C576 92.65 547.3 64 512 64zM528 384c0 8.822-7.178 16-16 16H64c-8.822 0-16-7.178-16-16V128c0-8.822 7.178-16 16-16h448c8.822 0 16 7.178 16 16V384zM140 152h-24c-6.656 0-12 5.344-12 12v24c0 6.656 5.344 12 12 12h24c6.656 0 12-5.344 12-12v-24C152 157.3 146.7 152 140 152zM196 200h24c6.656 0 12-5.344 12-12v-24c0-6.656-5.344-12-12-12h-24c-6.656 0-12 5.344-12 12v24C184 194.7 189.3 200 196 200zM276 200h24c6.656 0 12-5.344 12-12v-24c0-6.656-5.344-12-12-12h-24c-6.656 0-12 5.344-12 12v24C264 194.7 269.3 200 276 200zM356 200h24c6.656 0 12-5.344 12-12v-24c0-6.656-5.344-12-12-12h-24c-6.656 0-12 5.344-12 12v24C344 194.7 349.3 200 356 200zM460 152h-24c-6.656 0-12 5.344-12 12v24c0 6.656 5.344 12 12 12h24c6.656 0 12-5.344 12-12v-24C472 157.3 466.7 152 460 152zM140 232h-24c-6.656 0-12 5.344-12 12v24c0 6.656 5.344 12 12 12h24c6.656 0 12-5.344 12-12v-24C152 237.3 146.7 232 140 232zM196 280h24c6.656 0 12-5.344 12-12v-24c0-6.656-5.344-12-12-12h-24c-6.656 0-12 5.344-12 12v24C184 274.7 189.3 280 196 280zM276 280h24c6.656 0 12-5.344 12-12v-24c0-6.656-5.344-12-12-12h-24c-6.656 0-12 5.344-12 12v24C264 274.7 269.3 280 276 280zM356 280h24c6.656 0 12-5.344 12-12v-24c0-6.656-5.344-12-12-12h-24c-6.656 0-12 5.344-12 12v24C344 274.7 349.3 280 356 280zM460 232h-24c-6.656 0-12 5.344-12 12v24c0 6.656 5.344 12 12 12h24c6.656 0 12-5.344 12-12v-24C472 237.3 466.7 232 460 232zM400 320h-224C167.1 320 160 327.1 160 336V352c0 8.875 7.125 16 16 16h224c8.875 0 16-7.125 16-16v-16C416 327.1 408.9 320 400 320z"></path></svg>`);
  } else if ($props.name === "spinner") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 512 512",
      fill: "currentColor"
    }, _attrs))}><path d="M288 32C288 49.67 273.7 64 256 64C238.3 64 224 49.67 224 32C224 14.33 238.3 0 256 0C273.7 0 288 14.33 288 32zM288 480C288 497.7 273.7 512 256 512C238.3 512 224 497.7 224 480C224 462.3 238.3 448 256 448C273.7 448 288 462.3 288 480zM480 224C497.7 224 512 238.3 512 256C512 273.7 497.7 288 480 288C462.3 288 448 273.7 448 256C448 238.3 462.3 224 480 224zM32 288C14.33 288 0 273.7 0 256C0 238.3 14.33 224 32 224C49.67 224 64 238.3 64 256C64 273.7 49.67 288 32 288zM74.98 391.8C87.48 379.3 107.7 379.3 120.2 391.8C132.7 404.3 132.7 424.5 120.2 437C107.7 449.5 87.48 449.5 74.98 437C62.48 424.5 62.48 404.3 74.98 391.8zM391.8 437C379.3 424.5 379.3 404.3 391.8 391.8C404.3 379.3 424.5 379.3 437 391.8C449.5 404.3 449.5 424.5 437 437C424.5 449.5 404.3 449.5 391.8 437zM120.2 74.98C132.7 87.48 132.7 107.7 120.2 120.2C107.7 132.7 87.48 132.7 74.98 120.2C62.48 107.7 62.48 87.48 74.98 74.98C87.48 62.49 107.7 62.49 120.2 74.98z"></path></svg>`);
  } else if ($props.name === "align-justify") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 448 512",
      fill: "currentColor"
    }, _attrs))}><path d="M424 40C437.3 40 448 50.75 448 64C448 77.25 437.3 88 424 88H24C10.75 88 0 77.25 0 64C0 50.75 10.75 40 24 40H424zM424 168C437.3 168 448 178.7 448 192C448 205.3 437.3 216 424 216H24C10.75 216 0 205.3 0 192C0 178.7 10.75 168 24 168H424zM0 320C0 306.7 10.75 296 24 296H424C437.3 296 448 306.7 448 320C448 333.3 437.3 344 424 344H24C10.75 344 0 333.3 0 320zM424 424C437.3 424 448 434.7 448 448C448 461.3 437.3 472 424 472H24C10.75 472 0 461.3 0 448C0 434.7 10.75 424 24 424H424z"></path></svg>`);
  } else if ($props.name === "align-right") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 448 512",
      fill: "currentColor"
    }, _attrs))}><path d="M424 40C437.3 40 448 50.75 448 64C448 77.25 437.3 88 424 88H184C170.7 88 160 77.25 160 64C160 50.75 170.7 40 184 40H424zM424 168C437.3 168 448 178.7 448 192C448 205.3 437.3 216 424 216H24C10.75 216 0 205.3 0 192C0 178.7 10.75 168 24 168H424zM424 344H184C170.7 344 160 333.3 160 320C160 306.7 170.7 296 184 296H424C437.3 296 448 306.7 448 320C448 333.3 437.3 344 424 344zM424 424C437.3 424 448 434.7 448 448C448 461.3 437.3 472 424 472H24C10.75 472 0 461.3 0 448C0 434.7 10.75 424 24 424H424z"></path></svg>`);
  } else if ($props.name === "align-center") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 448 512",
      fill: "currentColor"
    }, _attrs))}><path d="M328 40C341.3 40 352 50.75 352 64C352 77.25 341.3 88 328 88H120C106.7 88 96 77.25 96 64C96 50.75 106.7 40 120 40H328zM424 168C437.3 168 448 178.7 448 192C448 205.3 437.3 216 424 216H24C10.75 216 0 205.3 0 192C0 178.7 10.75 168 24 168H424zM96 320C96 306.7 106.7 296 120 296H328C341.3 296 352 306.7 352 320C352 333.3 341.3 344 328 344H120C106.7 344 96 333.3 96 320zM424 424C437.3 424 448 434.7 448 448C448 461.3 437.3 472 424 472H24C10.75 472 0 461.3 0 448C0 434.7 10.75 424 24 424H424z"></path></svg>`);
  } else if ($props.name === "file-text") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 384 512",
      fill: "currentColor"
    }, _attrs))}><path d="M365.3 93.38l-74.63-74.64C278.6 6.742 262.3 0 245.4 0L64-.0001c-35.35 0-64 28.65-64 64l.0065 384c0 35.34 28.65 64 64 64H320c35.2 0 64-28.8 64-64V138.6C384 121.7 377.3 105.4 365.3 93.38zM336 448c0 8.836-7.164 16-16 16H64.02c-8.838 0-16-7.164-16-16L48 64.13c0-8.836 7.164-16 16-16h160L224 128c0 17.67 14.33 32 32 32h79.1V448zM96 280C96 293.3 106.8 304 120 304h144C277.3 304 288 293.3 288 280S277.3 256 264 256h-144C106.8 256 96 266.8 96 280zM264 352h-144C106.8 352 96 362.8 96 376s10.75 24 24 24h144c13.25 0 24-10.75 24-24S277.3 352 264 352z"></path></svg>`);
  } else if ($props.name === "file-pdf") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 384 512",
      fill: "currentColor"
    }, _attrs))}><path d="M320 464C328.8 464 336 456.8 336 448V416H384V448C384 483.3 355.3 512 320 512H64C28.65 512 0 483.3 0 448V416H48V448C48 456.8 55.16 464 64 464H320zM256 160C238.3 160 224 145.7 224 128V48H64C55.16 48 48 55.16 48 64V192H0V64C0 28.65 28.65 0 64 0H229.5C246.5 0 262.7 6.743 274.7 18.75L365.3 109.3C377.3 121.3 384 137.5 384 154.5V192H336V160H256zM88 224C118.9 224 144 249.1 144 280C144 310.9 118.9 336 88 336H80V368C80 376.8 72.84 384 64 384C55.16 384 48 376.8 48 368V240C48 231.2 55.16 224 64 224H88zM112 280C112 266.7 101.3 256 88 256H80V304H88C101.3 304 112 293.3 112 280zM160 240C160 231.2 167.2 224 176 224H200C226.5 224 248 245.5 248 272V336C248 362.5 226.5 384 200 384H176C167.2 384 160 376.8 160 368V240zM192 352H200C208.8 352 216 344.8 216 336V272C216 263.2 208.8 256 200 256H192V352zM336 224C344.8 224 352 231.2 352 240C352 248.8 344.8 256 336 256H304V288H336C344.8 288 352 295.2 352 304C352 312.8 344.8 320 336 320H304V368C304 376.8 296.8 384 288 384C279.2 384 272 376.8 272 368V240C272 231.2 279.2 224 288 224H336z"></path></svg>`);
  } else if ($props.name === "chevron-left") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 320 512",
      fill: "currentColor"
    }, _attrs))}><path d="M206.7 464.6l-183.1-191.1C18.22 267.1 16 261.1 16 256s2.219-11.97 6.688-16.59l183.1-191.1c9.152-9.594 24.34-9.906 33.9-.7187c9.625 9.125 9.938 24.37 .7187 33.91L73.24 256l168 175.4c9.219 9.5 8.906 24.78-.7187 33.91C231 474.5 215.8 474.2 206.7 464.6z"></path></svg>`);
  } else if ($props.name === "chevron-right") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 320 512",
      fill: "currentColor"
    }, _attrs))}><path d="M113.3 47.41l183.1 191.1c4.469 4.625 6.688 10.62 6.688 16.59s-2.219 11.97-6.688 16.59l-183.1 191.1c-9.152 9.594-24.34 9.906-33.9 .7187c-9.625-9.125-9.938-24.38-.7187-33.91l168-175.4L78.71 80.6c-9.219-9.5-8.906-24.78 .7187-33.91C88.99 37.5 104.2 37.82 113.3 47.41z"></path></svg>`);
  } else if ($props.name === "dropdown") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 512 512",
      fill: "currentColor"
    }, _attrs))}><path d="M384 232C397.3 232 408 242.7 408 256C408 269.3 397.3 280 384 280H128C114.7 280 104 269.3 104 256C104 242.7 114.7 232 128 232H384zM384 328C397.3 328 408 338.7 408 352C408 365.3 397.3 376 384 376H128C114.7 376 104 365.3 104 352C104 338.7 114.7 328 128 328H384zM0 96C0 60.65 28.65 32 64 32H448C483.3 32 512 60.65 512 96V416C512 451.3 483.3 480 448 480H64C28.65 480 0 451.3 0 416V96zM48 192V416C48 424.8 55.16 432 64 432H448C456.8 432 464 424.8 464 416V192H48zM436.7 96H363.3C356.2 96 352.6 104.6 357.7 109.7L394.3 146.3C397.5 149.5 402.5 149.5 405.7 146.3L442.3 109.7C447.4 104.6 443.8 96 436.7 96V96z"></path></svg>`);
  } else if ($props.name === "search") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 512 512",
      fill: "currentColor"
    }, _attrs))}><path d="M504.1 471l-134-134C399.1 301.5 415.1 256.8 415.1 208c0-114.9-93.13-208-208-208S-.0002 93.13-.0002 208S93.12 416 207.1 416c48.79 0 93.55-16.91 129-45.04l134 134C475.7 509.7 481.9 512 488 512s12.28-2.344 16.97-7.031C514.3 495.6 514.3 480.4 504.1 471zM48 208c0-88.22 71.78-160 160-160s160 71.78 160 160s-71.78 160-160 160S48 296.2 48 208z"></path></svg>`);
  } else if ($props.name === "times") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 320 512",
      fill: "currentColor"
    }, _attrs))}><path d="M312.1 375c9.369 9.369 9.369 24.57 0 33.94s-24.57 9.369-33.94 0L160 289.9l-119 119c-9.369 9.369-24.57 9.369-33.94 0s-9.369-24.57 0-33.94L126.1 256L7.027 136.1c-9.369-9.369-9.369-24.57 0-33.94s24.57-9.369 33.94 0L160 222.1l119-119c9.369-9.369 24.57-9.369 33.94 0s9.369 24.57 0 33.94L193.9 256L312.1 375z"></path></svg>`);
  } else if ($props.name === "resize-small") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 512 512",
      fill: "currentColor"
    }, _attrs))}><path d="M183 295l-81.38 81.38l-47.03-47.03c-6.127-6.117-14.29-9.367-22.63-9.367c-4.117 0-8.279 .8086-12.25 2.43c-11.97 4.953-19.75 16.63-19.75 29.56v135.1C.0013 501.3 10.75 512 24 512h136c12.94 0 24.63-7.797 29.56-19.75c4.969-11.97 2.219-25.72-6.938-34.87l-47.03-47.03l81.38-81.38c9.375-9.375 9.375-24.56 0-33.94S192.4 285.7 183 295zM487.1 0h-136c-12.94 0-24.63 7.797-29.56 19.75c-4.969 11.97-2.219 25.72 6.938 34.87l47.04 47.03l-81.38 81.38c-9.375 9.375-9.375 24.56 0 33.94s24.56 9.375 33.94 0l81.38-81.38l47.03 47.03c6.127 6.117 14.3 9.35 22.63 9.35c4.117 0 8.275-.7918 12.24-2.413C504.2 184.6 512 172.9 512 159.1V23.1C512 10.75 501.3 0 487.1 0z"></path></svg>`);
  } else if ($props.name === "resize-medium") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 512 512",
      fill: "currentColor"
    }, _attrs))}><path d="M183 295l-81.38 81.38l-47.03-47.03c-6.127-6.117-14.29-9.367-22.63-9.367c-4.117 0-8.279 .8086-12.25 2.43c-11.97 4.953-19.75 16.63-19.75 29.56v135.1C.0013 501.3 10.75 512 24 512h136c12.94 0 24.63-7.797 29.56-19.75c4.969-11.97 2.219-25.72-6.938-34.87l-47.03-47.03l81.38-81.38c9.375-9.375 9.375-24.56 0-33.94S192.4 285.7 183 295zM487.1 0h-136c-12.94 0-24.63 7.797-29.56 19.75c-4.969 11.97-2.219 25.72 6.938 34.87l47.04 47.03l-81.38 81.38c-9.375 9.375-9.375 24.56 0 33.94s24.56 9.375 33.94 0l81.38-81.38l47.03 47.03c6.127 6.117 14.3 9.35 22.63 9.35c4.117 0 8.275-.7918 12.24-2.413C504.2 184.6 512 172.9 512 159.1V23.1C512 10.75 501.3 0 487.1 0z"></path></svg>`);
  } else if ($props.name === "resize-large") {
    _push(`<svg${ssrRenderAttrs(mergeProps({
      viewBox: "0 0 512 512",
      fill: "currentColor"
    }, _attrs))}><path d="M183 295l-81.38 81.38l-47.03-47.03c-6.127-6.117-14.29-9.367-22.63-9.367c-4.117 0-8.279 .8086-12.25 2.43c-11.97 4.953-19.75 16.63-19.75 29.56v135.1C.0013 501.3 10.75 512 24 512h136c12.94 0 24.63-7.797 29.56-19.75c4.969-11.97 2.219-25.72-6.938-34.87l-47.03-47.03l81.38-81.38c9.375-9.375 9.375-24.56 0-33.94S192.4 285.7 183 295zM487.1 0h-136c-12.94 0-24.63 7.797-29.56 19.75c-4.969 11.97-2.219 25.72 6.938 34.87l47.04 47.03l-81.38 81.38c-9.375 9.375-9.375 24.56 0 33.94s24.56 9.375 33.94 0l81.38-81.38l47.03 47.03c6.127 6.117 14.3 9.35 22.63 9.35c4.117 0 8.275-.7918 12.24-2.413C504.2 184.6 512 172.9 512 159.1V23.1C512 10.75 501.3 0 487.1 0z"></path></svg>`);
  } else if ($props.name === "refresh") {
    _push(`<svg${ssrRenderAttrs(mergeProps({ viewBox: "0 0 512 512" }, _attrs))}><path d="M454.7 288.1c-12.78-3.75-26.06 3.594-29.75 16.31C403.3 379.9 333.8 432 255.1 432c-66.53 0-126.8-38.28-156.5-96h100.4c13.25 0 24-10.75 24-24S213.2 288 199.9 288h-160c-13.25 0-24 10.75-24 24v160c0 13.25 10.75 24 24 24s24-10.75 24-24v-102.1C103.7 436.4 176.1 480 255.1 480c99 0 187.4-66.31 215.1-161.3C474.8 305.1 467.4 292.7 454.7 288.1zM472 16C458.8 16 448 26.75 448 40v102.1C408.3 75.55 335.8 32 256 32C157 32 68.53 98.31 40.91 193.3C37.19 206 44.5 219.3 57.22 223c12.84 3.781 26.09-3.625 29.75-16.31C108.7 132.1 178.2 80 256 80c66.53 0 126.8 38.28 156.5 96H312C298.8 176 288 186.8 288 200S298.8 224 312 224h160c13.25 0 24-10.75 24-24v-160C496 26.75 485.3 16 472 16z"></path></svg>`);
  } else if ($props.name === "building") {
    _push(`<svg${ssrRenderAttrs(mergeProps({ viewBox: "0 0 384 512" }, _attrs))}><path d="M64 120C64 106.7 74.75 96 88 96H136C149.3 96 160 106.7 160 120V168C160 181.3 149.3 192 136 192H88C74.75 192 64 181.3 64 168V120zM96 128V160H128V128H96zM296 96C309.3 96 320 106.7 320 120V168C320 181.3 309.3 192 296 192H248C234.7 192 224 181.3 224 168V120C224 106.7 234.7 96 248 96H296zM288 160V128H256V160H288zM64 248C64 234.7 74.75 224 88 224H136C149.3 224 160 234.7 160 248V296C160 309.3 149.3 320 136 320H88C74.75 320 64 309.3 64 296V248zM96 256V288H128V256H96zM296 224C309.3 224 320 234.7 320 248V296C320 309.3 309.3 320 296 320H248C234.7 320 224 309.3 224 296V248C224 234.7 234.7 224 248 224H296zM288 288V256H256V288H288zM64 512C28.65 512 0 483.3 0 448V64C0 28.65 28.65 0 64 0H320C355.3 0 384 28.65 384 64V448C384 483.3 355.3 512 320 512H64zM32 64V448C32 465.7 46.33 480 64 480H128V416C128 380.7 156.7 352 192 352C227.3 352 256 380.7 256 416V480H320C337.7 480 352 465.7 352 448V64C352 46.33 337.7 32 320 32H64C46.33 32 32 46.33 32 64zM224 416C224 398.3 209.7 384 192 384C174.3 384 160 398.3 160 416V480H224V416z"></path></svg>`);
  } else if ($props.name === "globe") {
...
const Icon = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$a]]);
const _sfc_main$a = {
  props: {
    className: String,
    placement: {
...
const Dropdown = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$9]]);
const _sfc_main$9 = {
  components: {
    Icon,
    Link
...
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-menu" }, _attrs))}><div class="menu-header"><div class="flex items-center space-x-3 px-4 py-3"><div class="p-2 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl">`);
  _push(ssrRenderComponent(_component_icon, {
    name: "settings",
    class: "w-6 h-6 text-white"
  }, null, _parent));
  _push(`</div><div><h2 class="text-lg font-bold text-gray-900">${ssrInterpolate(_ctx.$t("Settings"))}</h2><p class="text-xs text-gray-500">${ssrInterpolate(_ctx.$t("System Configuration"))}</p></div></div></div><div class="menu-content"><!--[-->`);
  ssrRenderList($data.menu_items, (menu_item, m_index) => {
    _push(`<div class="${ssrRenderClass([{ "active": $options.isUrl(menu_item.url) }, "menu-item-group"])}"><div class="${ssrRenderClass([{ "active": $options.isUrl(menu_item.url), "has-submenu": menu_item.submenu }, "menu-item"])}">`);
    if (!menu_item.submenu) {
      _push(ssrRenderComponent(_component_Link, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="menu-item-content"${_scopeId}><div class="${ssrRenderClass([$options.getIconColor(menu_item.icon), "menu-icon-wrapper"])}"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_icon, {
              name: menu_item.icon,
              class: "w-5 h-5"
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="menu-text"${_scopeId}><div class="menu-name"${_scopeId}>${ssrInterpolate(_ctx.$t(menu_item.name))}</div><div class="menu-description"${_scopeId}>${ssrInterpolate($options.getMenuDescription(menu_item.name))}</div></div>`);
            if (menu_item.submenu) {
              _push2(`<div class="menu-arrow"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_icon, {
                name: "chevron-right",
                class: ["w-4 h-4 transition-transform duration-200", { "rotate-90": $data.expandedMenus.includes(m_index) }]
              }, null, _parent2, _scopeId));
              _push2(`</div>`);
            } else {
              _push2(`<!---->`);
            ...
            return [
              createVNode("div", { class: "menu-item-content" }, [
                createVNode("div", {
                  class: ["menu-icon-wrapper", $options.getIconColor(menu_item.icon)]
                }, [
                ...
                createVNode("div", { class: "menu-text" }, [
                  createVNode("div", { class: "menu-name" }, toDisplayString(_ctx.$t(menu_item.name)), 1),
                  createVNode("div", { class: "menu-description" }, toDisplayString($options.getMenuDescription(menu_item.name)), 1)
                ]),
                menu_item.submenu ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "menu-arrow"
                }, [
                  createVNode(_component_icon, {
      ...
      _push(`<div class="menu-link cursor-pointer"><div class="menu-item-content"><div class="${ssrRenderClass([$options.getIconColor(menu_item.icon), "menu-icon-wrapper"])}">`);
      _push(ssrRenderComponent(_component_icon, {
        name: menu_item.icon,
        class: "w-5 h-5"
      }, null, _parent));
      _push(`</div><div class="menu-text"><div class="menu-name">${ssrInterpolate(_ctx.$t(menu_item.name))}</div><div class="menu-description">${ssrInterpolate($options.getMenuDescription(menu_item.name))}</div></div><div class="menu-arrow">`);
      _push(ssrRenderComponent(_component_icon, {
        name: "chevron-right",
        class: ["w-4 h-4 transition-transform duration-200", { "rotate-90": $data.expandedMenus.includes(m_index) }]
      }, null, _parent));
    ...
    if (menu_item.submenu) {
      _push(`<div class="${ssrRenderClass([{ "expanded": $data.expandedMenus.includes(m_index) }, "submenu-container"])}"><div class="submenu-items"><!--[-->`);
      ssrRenderList(menu_item.submenu, (sub_menu_item, s_m_index) => {
        _push(ssrRenderComponent(_component_Link, {
          key: s_m_index,
          class: ["submenu-item", { "active": $options.isUrl(sub_menu_item.url) }],
          href: sub_menu_item.param ? _ctx.route(sub_menu_item.route, sub_menu_item.param) : _ctx.route(sub_menu_item.route)
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="submenu-item-content"${_scopeId}><div class="submenu-icon"${_scopeId}>`);
              ...
              _push2(`</div><div class="submenu-text"${_scopeId}><div class="submenu-name"${_scopeId}>${ssrInterpolate(_ctx.$t(sub_menu_item.name))}</div></div></div>`);
            } else {
              return [
                createVNode("div", { class: "submenu-item-content" }, [
                  createVNode("div", { class: "submenu-icon" }, [
                  ...
                  createVNode("div", { class: "submenu-text" }, [
                    createVNode("div", { class: "submenu-name" }, toDisplayString(_ctx.$t(sub_menu_item.name)), 1)
                  ])
                ])
              ];
            }
...
const MainMenu = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$8]]);
const _sfc_main$8 = {
...
const TopProjectMenu = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$7]]);
const _sfc_main$7 = {
  inheritAttrs: false,
  props: {
    id: {
...
const SelectInput = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$6 = {
  name: "create-project",
  props: {
    top: {
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if (!$data.loading) {
    ...
    _push(`</div></div><div class="flex justify-center"><div class="w-[70%] h-[100px] p-3 flex rounded justify-center" style="${ssrRenderStyle({ backgroundImage: "url(" + $data.project.color.image + ")", backgroundColor: $data.project.color.bg })}"><img src="/images/board.svg" class="w-auto max-h-full" alt="Board"></div></div><div class="flex"><label class="flex flex-col"><div class="title mb-2">${ssrInterpolate(_ctx.$t("Background"))}</div><div class="color__list"><ul class="grid grid-cols-5 gap-2.5 auto-rows-max"><!--[-->`);
    ssrRenderList($data.selected_backgrounds, (color) => {
      _push(`<li class="flex justify-center"><button class="w-10 h-8 flex items-center justify-center rounded transition-opacity hover:opacity-80" style="${ssrRenderStyle({ backgroundImage: "url(" + color.image + ")", backgroundColor: color.bg })}">`);
    ...
    _push(`<!--]-->`);
    if ($data.selected_backgrounds.length < $data.backgrounds.length) {
      _push(`<li class="flex justify-center"><button class="w-10 h-8 flex items-center justify-center rounded bg-black hover:bg-gray-800 transition-colors" type="button"><span class="text-white text-xs font-medium">more</span></button></li>`);
    } else {
      _push(`<!---->`);
    }
...
const CreateProject = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["ssrRender", _sfc_ssrRender$5]]);
const _sfc_main$5 = {
...
const CreateWorkspace = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$4]]);
const _sfc_main$4 = {
...
const TopWorkspaceMenu = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$3 = {
...
const InviteWorkspaceMember = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$2]]);
const _sfc_main$2 = {
  name: "workspace-menu",
  components: {
  ...
  methods: {
    ...
    isWorkspaceTasksActive() {
      ...
      if (url.includes("/tasks/board") || url.includes("/tasks/calendar") || url.includes("/tasks/timeline") || url.includes("/tasks/table")) {
        return true;
      }
      return false;
    },
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($data.workspace) {
    ...
    if ($data.workspace.member.role === "admin") {
      _push(`<li>`);
      _push(ssrRenderComponent(_component_Link, {
        href: _ctx.route("workspace.view.board", $data.workspace.slug || $data.workspace.id),
        class: ["flex items-center px-3 py-2 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group", { "active": $options.isWorkspaceTasksActive() }]
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_icon, {
    ...
    _push(`<li>`);
    _push(ssrRenderComponent(_component_Link, {
      href: _ctx.route("workspace.view.my-tasks.board", $data.workspace.slug || $data.workspace.id),
      class: ["flex items-center px-3 py-2 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group", { "active": $options.isMyTasksActive() }]
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(ssrRenderComponent(_component_icon, {
...
const WorkspaceMenu = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const handleNotificationClick = (notification) => {
      ...
      if (!notification.read_at) {
        ...
        if (index !== -1) {
          notifications.value[index].read_at = (/* @__PURE__ */ new Date()).toISOString();
        }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative" }, _attrs))}><button class="relative text-white opacity-90 hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 rounded-full p-1">`);
      _push(ssrRenderComponent(Icon, {
        name: "notification",
        class: "h-6 w-6 bell__icon"
      }, null, _parent));
      if (unreadCount.value > 0) {
        _push(`<span class="absolute -top-1 -right-1 flex h-4 w-4"><span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span><span class="relative inline-flex rounded-full h-4 w-4 bg-red-500 dark:bg-gray-600 items-center justify-center text-xs text-white dark:text-white">${ssrInterpolate(unreadCount.value)}</span></span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</button><div style="${ssrRenderStyle(isOpen.value ? null : { display: "none" })}" class="absolute top-5 right-0 mt-3 w-80 sm:w-96 origin-top-right rounded-md shadow-lg bg-gray-100 dark:bg-gray-800 ring-1 ring-black dark:ring-white ring-opacity-5 z-50"><div class="flex justify-between items-center p-3 border-b border-gray-200 dark:border-gray-700"><h3 class="font-semibold text-gray-700 dark:text-white">Notifications</h3><div class="relative"><button class="p-1 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400"><svg class="h-5 w-5 text-gray-600 dark:text-gray-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path d="M10 6a2 2 0 110-4 2 2 0 010 4zM10 12a2 2 0 110-4 2 2 0 010 4zM10 18a2 2 0 110-4 2 2 0 010 4z"></path></svg></button>`);
      if (isMenuOpen.value) {
        _push(`<div class="absolute right-0 mt-1 w-48 origin-top-right rounded-md shadow-lg bg-gray-100 dark:bg-gray-800 ring-1 ring-black dark:ring-white ring-opacity-5 z-10"><div class="py-1"><button class="w-full text-left block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"> Mark all as read </button>`);
      ...
      if (notifications.value.length > 0) {
        ...
        ssrRenderList(notifications.value, (n) => {
          ...
          _push(ssrRenderComponent(unref(Link), {
            key: n.id || n.task_id,
            href: ((_a = n.data) == null ? void 0 : _a.url) || "#",
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              ...
              if (_push2) {
                _push2(`<div class="flex items-start space-x-3"${_scopeId}><div class="flex-shrink-0"${_scopeId}>`);
                if ((_a2 = n.data) == null ? void 0 : _a2.action_user_photo) {
                  _push2(`<img class="h-8 w-8 rounded-full object-cover"${ssrRenderAttr("src", n.data.action_user_photo)}${ssrRenderAttr("alt", (_b = n.data) == null ? void 0 : _b.action_user_name)}${_scopeId}>`);
                } else {
                  _push2(`<div class="h-8 w-8 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center text-gray-500 dark:text-white font-bold"${_scopeId}>${ssrInterpolate((_d = (_c = n.data) == null ? void 0 : _c.action_user_name) == null ? void 0 : _d.charAt(0))}</div>`);
                }
                _push2(`</div><div class="flex-1 min-w-0"${_scopeId}><p class="text-sm text-gray-800 dark:text-gray-300 leading-snug"${_scopeId}><strong class="font-medium dark:text-white"${_scopeId}>${ssrInterpolate((_e = n.data) == null ? void 0 : _e.action_user_name)}</strong> ${ssrInterpolate((_f = n.data) == null ? void 0 : _f.message)} on task <strong class="font-medium text-blue-600 dark:text-blue-400"${_scopeId}>“${ssrInterpolate((_g = n.data) == null ? void 0 : _g.task_title)}”</strong> in project <strong class="font-medium dark:text-white"${_scopeId}>“${ssrInterpolate((_h = n.data) == null ? void 0 : _h.project_name)}”</strong> under workspace <strong class="font-medium dark:text-white"${_scopeId}>“${ssrInterpolate((_i = n.data) == null ? void 0 : _i.workspace_name)}”</strong>. </p><div class="text-xs text-gray-500 dark:text-gray-400 mt-2"${_scopeId}><span${_scopeId}>${ssrInterpolate(formatTimeAgo(n.created_at))}</span></div></div></div>`);
              } else {
                return [
                  createVNode("div", { class: "flex items-start space-x-3" }, [
                    createVNode("div", { class: "flex-shrink-0" }, [
                      ((_j = n.data) == null ? void 0 : _j.action_user_photo) ? (openBlock(), createBlock("img", {
                        key: 0,
                        class: "h-8 w-8 rounded-full object-cover",
                        src: n.data.action_user_photo,
                        alt: (_k = n.data) == null ? void 0 : _k.action_user_name
                      ...
                      }, toDisplayString((_m = (_l = n.data) == null ? void 0 : _l.action_user_name) == null ? void 0 : _m.charAt(0)), 1))
                    ]),
                    createVNode("div", { class: "flex-1 min-w-0" }, [
                      createVNode("p", { class: "text-sm text-gray-800 dark:text-gray-300 leading-snug" }, [
                        createVNode("strong", { class: "font-medium dark:text-white" }, toDisplayString((_n = n.data) == null ? void 0 : _n.action_user_name), 1),
                        createTextVNode(" " + toDisplayString((_o = n.data) == null ? void 0 : _o.message) + " on task ", 1),
                        createVNode("strong", { class: "font-medium text-blue-600 dark:text-blue-400" }, "“" + toDisplayString((_p = n.data) == null ? void 0 : _p.task_title) + "”", 1),
                        createTextVNode(" in project "),
                        createVNode("strong", { class: "font-medium dark:text-white" }, "“" + toDisplayString((_q = n.data) == null ? void 0 : _q.project_name) + "”", 1),
                        createTextVNode(" under workspace "),
                        createVNode("strong", { class: "font-medium dark:text-white" }, "“" + toDisplayString((_r = n.data) == null ? void 0 : _r.workspace_name) + "”", 1),
                        createTextVNode(". ")
                      ]),
                      createVNode("div", { class: "text-xs text-gray-500 dark:text-gray-400 mt-2" }, [
                        createVNode("span", null, toDisplayString(formatTimeAgo(n.created_at)), 1)
                      ])
                    ])
                  ])
                ];
        ...
        _push(`<div class="p-6 text-center text-sm text-gray-500 dark:text-gray-400"> You&#39;re all caught up! </div>`);
      }
      _push(`</div></div>`);
    };
  }
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Shared/NotificationBell.vue");
...
const _sfc_main = {
  ...
  data() {
    ...
    return {
      ...
      activeTimerString: "",
      counter: { seconds: 0, timer: ((_a = this.auth) == null ? void 0 : _a.timer) || 0, duration: 0 },
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_notification_bell = resolveComponent("notification-bell");
  ...
  }, _attrs))}><div id="dropdown"></div><div class="md:flex md:flex-col"><div class="md:h-screen md:flex md:flex-col"><div class="md:flex md:shrink-0"><div class="w-full p-4 md:py-2 md:pr-12 md:pl-8 text-sm flex justify-first items-center top_bar" style="${ssrRenderStyle([_ctx.$page.props.project && _ctx.$page.props.project.background ? { backgroundColor: _ctx.$page.props.project.background.top } : null])}"><div class="placement-top-left w-full"><div class="flex w-full lg:flex-row flex-col"><div class="flex gap-3 select-none top_bar__menu">`);
  _push(ssrRenderComponent(_component_Link, {
    class: "mr-2",
    href: "/"
  }, {
  ...
  _push(ssrRenderComponent(_component_notification_bell, { class: "flex items-center" }, null, _parent));
